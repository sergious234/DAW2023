                ...
                <div class="grid min-h-screen grid-cols-3">
                    ...
                    <div>
                        <section class="pt-10 text-white">
                            ...
                            <p class="text-center pt-2 max-w-full">
                                Registrate
                            </p>
                        </section>

                        <form action="/SPR/users/add" method="POST" class="text-white 
                              text-lg 
                              pt-10 text-center justify-center flex flex-col items-center
                              ">
                            <div class="pt-6">
                                <p id="msgName">Nombre*</p>
                                <input required class="rounded-md pl-2 text-black" id="user_name" type="text" name="user_name" />
                            </div>
                            ...
                            <div class="pt-6">
                                ...
                                <input required class="rounded-md pl-2 text-black" id="password" type="password" name="password" />
                            </div>
                            <p class="font-semibold" id="spanClave"></p>

                            <div class="pt-10 flex justify-center">
                                <input type="submit" class="px-3 rounded-md bg-white text-black text-center" value="Aceptar">
                            </div>
                        </form>
                    </div>
